...
ok(
    ...
    'total inclusive time (126.517) - summarized inclusive times of subnodes'
  );
...
is( $top->total_exclusive_time, 1.694, 'total inclusive time (11.416) - summarized inclusive times of subplans and initplans' );
